  ...
  <section id="what-we-do" className="bg-secondary py-20 md:py-[100px]">
    <div className="max-w-content mx-auto px-6">
      ...
      <div className="space-y-6 text-foreground/90 text-[17px] md:text-lg leading-[1.7] font-sans">
        ...
        <p>
          Most large enterprises have declared AI a strategic priority. They're investing heavily, running pilots, and increasingly disclosing AI as a material risk. Yet the majority prioritize AI based on ROI while seeing value only in cost reduction, not growth or competitive advantage.
        </p>
        <p className="font-medium">The constraint isn't model capability. It's operating design.</p>
        <p className="font-medium">Most leadership teams are still organized for a world where execution was scarce and scale was expensive.</p>
